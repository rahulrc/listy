<script lang="ts">
	...
	$: console.log('Current traveler in safeResults:', safeResults.travelers?.[activeTab]);
		...
		function sharePackingList() {
			...
			let content = `${results?.trip_summary || 'Trip'}\n`;
			...
			content += `Create your own smart packing list at: https://listy.vercel.app`;
			return content;
		}
	...
	<div class="container mx-auto px-4 py-8">
		...
		<div class="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
			...
			<h2 class="text-2xl font-bold text-white mb-2 font-nunito">
				{getTravelerDisplayName(results?.travelers?.[activeTab]?.provided_name, activeTab)} Packing List
			</h2>
		</div>
			...
			{#if results?.travelers?.[activeTab]?.packing_list}
				<div class="space-y-6">
					...
					<div class="text-center mt-6">
						<button
							on:click={sharePackingList}
							class="bg-gradient-to-r from-green-500 to-blue-500 hover:from-green-600 hover:to-blue-600 text-white font-semibold py-3 px-6 rounded-xl transition-all duration-300 font-quicksand transform hover:-translate-y-1 hover:shadow-lg flex items-center justify-center mx-auto space-x-2"
						>
							<span>📤</span>
